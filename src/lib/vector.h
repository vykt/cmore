...
//external
int cm_vector_get_val(const cm_vector * vector, 
                      const int index, void  * buf);
void  * cm_vector_get_ref(const cm_vector * vector, 
                          const int index);

int cm_vector_set(cm_vector * vector, 
                  const int index, const void  * data);
int cm_vector_insert(cm_vector * vector, 
                     const int index, const void  * data);
